    ...
    for dsrc_r in DSRC_r:
        ...
        for r in range(1,40,1):
            ...
            for v2x in V2X:
                ...
                xi_comm,eta_comm = NetServe(v2x, v2x_id[v2x],R*propotion,B*propotion,dsrc_r,gamm=gamm)
        ...
        Latency_comm[dsrc_r].append(Latency_network)
